...
public class TinyDemo extends JFrame implements Runnable {
  ...
  public static final String[] floorDoms = {"floor.1", "floor.2"};
  public static final String[] subnets = {"192.168.50", "192.168.51"};
  ...
  public static final String[] sysadmins = {"Jane", "Eve", "Edward", "Bernice", "Bill"};
  ...
  class SpitMonitor implements Runnable {
    ...
    public SpitMonitor ( TinyDemo da ) {
      this.da = da;
    }
  ...
  class StreamMonitor implements Runnable {
    ...
    public StreamMonitor ( TinyDemo da, int min, int add, long minDuration, long ranDuration,
  ...
  class TrickleMonitor implements Runnable {
    ...
    public TrickleMonitor ( TinyDemo da, String from, String to ) {
      this.da = da;
      this.from = from;
      this.to = to;
    }
